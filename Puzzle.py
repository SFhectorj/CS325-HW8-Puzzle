...
def solve_puzzle(Board, Source, Destination):
    ...
    Updated to output directions in string
    """
    # Directions for moving
    # (Left, Right, Up, Down)
    # Updating to output in form of string
    movement_directions = [(-1,0, 'U'),(1, 0, 'D'),(0, -1, 'L'),(0, 1, 'R')]
    ...
    while queue:
        current_cell, current_path, dir_path = queue.popleft()

        # Check if current cell is at destination
        if current_cell == Destination:
            return current_path, dir_path
...
# Test cases
print(solve_puzzle(puzzle, (0, 2), (2, 2)))  # ([(0, 2), (0, 1), (1, 1), (2, 1), (2, 2)], 'LDDR')
print(solve_puzzle(puzzle, (0, 0), (4, 4)))  # ([(0, 0), (0, 1), (0, 2), ..., (4, 4)], 'RRRRDDDD')
print(solve_puzzle(puzzle, (0, 0), (4, 0)))  # None
print(solve_puzzle(puzzle, (0, 0), (0, 0)))  # ([(0, 0)], '')